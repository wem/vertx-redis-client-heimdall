...
internal class RedisHeimdallLightTest : AbstractRedisTest() {
    ...
    private suspend fun RedisHeimdallLight.sendCmd() =
        sendAwait(Request.cmd(Command.INCR).arg("key"))

    private suspend fun RedisHeimdallLight.sendBatch() =
        batchAwait(listOf(Request.cmd(Command.INCR).arg("key")))
}